...
class AssignedOrderWidget extends StatelessWidget {
  /*
  * Callback function
  */
  ...
  AssignedOrderWidget(this.order, {this.complete, this.reject});
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    InkWell(
                      ...
                      onTap: () => launch("tel:${order.clientUser.phoneNumber}"),
                    ),
                    Spacer(),
                    Text(
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          SizedBox(height: 3),
                          Text(
                            ConstantValues.CURRENCY_SYMBOL + '${order.paymentAmount}',
                            textAlign: TextAlign.center,
                            style: GoogleFonts.ubuntu(
                              fontSize: 14,
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    InkWell(
                      ...
                      onTap: () => MapUtils.openMap(order.clientLatitude, order.clientLongitude),
                    ),
                  ],
                ),
              ),
                      ...
                      Expanded(
                        child: FlatButton(
                          ...
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: <Widget>[
                              Icon(Icons.check, color: Colors.indigo, size: 18),
                              SizedBox(width: 6),
                              Text(
